...
//           break;
//   }
//   if (event.data.type === 'updateScene') {
//     const { cameraData, modelData } = event.data;
    
//     // Perform occlusion culling and LOD calculations in the worker
//     const visibleModels = performOcclusionCulling(cameraData, modelData);
